        ...
        <section className="flex justify-between mb-40 padding-x max-lg:flex-col">
            ...
            <div className="w-2/5 mt-4 max-lg:w-full max-lg:text-center max-lg:mb-10">
                ...
                <div className="text-xl leading-normal max-lg:text-lg max-lg:leading-relaxed">
                    <p className='mt-7'>Embark on a shopping journey that redefines your experience with unbeatable deals. From premier selections to incredible savings, we offer unparalleled value that sets us apart.</p>
                    <p className='mt-7'>Navigate a realm of possibilities designed to fulfill your unique desires, surpassing the loftiest expectations. Your journey with us is nothing short of exceptional.</p>
                </div>
